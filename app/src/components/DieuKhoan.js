  ...
  return (
    <>
      ...
      >
        ...
        <Typography.Paragraph>
          Long Bình sẽ thẩm định đơn vay đầu tiên của bạn trong vòng 30
          phút – 1 tiếng. Với các đơn vay tiếp theo sau khi bạn đã được vay ,
          thời gian thẩm định chỉ 5 phút
        </Typography.Paragraph>
        <Typography.Paragraph>
          Long Bình sẽ thẩm đinh các thông tin của bạn cung cấp ,cung
        ...
        <Typography.Paragraph>
          Vui lòng liên hệ tới sự hỗ trợ của Ngân hàng Shinhan Bank để được hỗ trợ
        </Typography.Paragraph>
      </Modal>
    </>
  );
